dependencies:
  apollo-server-micro: 2.22.1_graphql@15.5.0
  aws-sdk: 2.873.0
  bcryptjs: 2.4.3
  dotenv: 8.2.0
  esm: 3.2.25
...
packages:
  ...
  /apollo-server-core/2.22.1_graphql@15.5.0:
    dependencies:
      '@apollographql/apollo-tools': 0.4.9
      '@apollographql/graphql-playground-html': 1.6.27
      '@apollographql/graphql-upload-8-fork': 8.1.3_graphql@15.5.0
  ...
  /apollo-server-micro/2.22.1_graphql@15.5.0:
    ...
    peerDependencies:
      graphql: '*'
    resolution:
      integrity: sha512-D8HY95gYDRzx6sDgwooft0bo1Dwu2MiSHF2WXQbSwWlUu/bPq9sclbH/rOnqeMc8IGlWpYd9KraKR3LTif3hUg==
  /apollo-server-plugin-base/0.11.0_graphql@15.5.0:
    dependencies:
      apollo-server-types: 0.7.0_graphql@15.5.0
      graphql: 15.5.0
